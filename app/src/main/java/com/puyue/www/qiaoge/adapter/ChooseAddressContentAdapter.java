 ...
 */
public class ChooseAddressContentAdapter extends BaseQuickAdapter<AddressModel.DataBean,BaseViewHolder> {

    public ChooseAddressContentAdapter(int layoutResId, @Nullable List<AddressModel.DataBean> data) {
