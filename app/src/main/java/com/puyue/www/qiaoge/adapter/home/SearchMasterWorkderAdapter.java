...
public class SearchMasterWorkderAdapter  extends BaseQuickAdapter<SearchMasterWorkderModel.DataBean.ListBean, BaseViewHolder> {

    public SearchMasterWorkderAdapter(int layoutResId, List<SearchMasterWorkderModel.DataBean.ListBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, SearchMasterWorkderModel.DataBean.ListBean model) {
        GlideModel.disPlayErrorPlace(mContext,model.mainPicUrl,helper.getView(R.id.iv_item_goods_img));
