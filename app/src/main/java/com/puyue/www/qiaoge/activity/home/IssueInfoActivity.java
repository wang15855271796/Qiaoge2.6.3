...
import com.puyue.www.qiaoge.activity.home.CascadingMenuPopWindow;
import com.puyue.www.qiaoge.activity.mine.order.ReturnGoodActivity;
import com.puyue.www.qiaoge.adapter.ShopImageViewAdapter;
    ...
    public void setViewData() {
        ...
        tv_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("wsdgdsfdsgffdgff....",et_phone.getText().toString()+"000");
                Log.d("wsdgdsfdsgffdgff....",tv_address.getText().toString()+"111");
            }
        });
