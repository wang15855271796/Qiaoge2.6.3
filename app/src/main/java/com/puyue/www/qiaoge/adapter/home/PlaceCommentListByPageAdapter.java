...
public class PlaceCommentListByPageAdapter extends BaseQuickAdapter<GetPlaceCommentListByPageModel.DataBean.ListBean, BaseViewHolder> {
    private ImageView mIvHeader;
    private TextView mTvReply;

    public PlaceCommentListByPageAdapter(int layoutResId, List<GetPlaceCommentListByPageModel.DataBean.ListBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, GetPlaceCommentListByPageModel.DataBean.ListBean model) {
