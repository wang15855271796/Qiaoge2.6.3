 ...
 */
public class Team3Adapter extends RecyclerView.Adapter<Team3Adapter.BaseViewHolder> implements View.OnClickListener{
    ...
    public Team3Adapter(Context context,String style, int layoutResId, List<CouponModel.DataBean.ActivesBean> actives,String flag,OnClick onClick) {
