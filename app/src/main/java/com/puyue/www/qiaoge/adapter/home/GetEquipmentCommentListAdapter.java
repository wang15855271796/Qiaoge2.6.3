 ...
 * Created by WinSinMin on 2018/5/15.
 */
...
public class GetEquipmentCommentListAdapter extends BaseQuickAdapter<GetEquipmentCommentListByPageModel.DataBean.ListBean, BaseViewHolder> {
    ...
    public GetEquipmentCommentListAdapter(int layoutResId, List<GetEquipmentCommentListByPageModel.DataBean.ListBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, GetEquipmentCommentListByPageModel.DataBean.ListBean model) {
