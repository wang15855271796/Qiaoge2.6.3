...
public class MySubOrdersItemAdapter extends BaseQuickAdapter<MyOrdersModel.DataBean.ListBean, BaseViewHolder> {
    ...
    public MySubOrdersItemAdapter(int layoutResId, String subId,@Nullable List<MyOrdersModel.DataBean.ListBean> data, int orderState, int orderDeliveryType, MyOrdersItemAdapter.OnClick onClick) {
