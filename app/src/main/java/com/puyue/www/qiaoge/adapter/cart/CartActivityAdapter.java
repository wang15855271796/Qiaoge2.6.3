 ...
 * 描述：
 */
public class CartActivityAdapter extends BaseQuickAdapter<CartListModel.DataBean.ListBean.ValidListBean, BaseViewHolder> {
    public CartActivityAdapter(int layoutResId, @Nullable List<CartListModel.DataBean.ListBean.ValidListBean> data) {
...
//
//    public CartActivityAdapter(int layoutResId, @Nullable List<CartListModel.DataBean.ListBean.ValidListBean> data, Map<Integer, Boolean> isCheck
...
////        Log.e("CartActivity", "CartAdapter: "+code );
//    }
//
...
//    }
//
//    public void setOnItemClickListener(CartActivityAdapter.OnEventClickListener onEventClickListener) {
...
//        CartActivity.CartStandardAdapter mAdapterCartStandard;
//        Log.d("dangqianshujujiekou....",""+item);
...
//        }
//
//        ImageView iv_add = helper.getView(R.id.iv_item_cart_img_add);
//        ImageView iv_flag_add = helper.getView(R.id.iv_flag_add);
...
//            GlideModel.disPlayErrorPlace(mContext, item.picUrl, helper.getView(R.id.iv_item_cart_img));
...
//        mAdapterCartStandard = new CartActivity.CartStandardAdapter(R.layout.item_cart_standard, item.productDescVOList, item.businessType, item.businessId);
//
//        mAdapterCartStandard.setOnItemClickListener(new CartActivity.CartStandardAdapter.OnEventClickListener() {
//            @Override
